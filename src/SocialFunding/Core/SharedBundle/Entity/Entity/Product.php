 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="SocialFunding\Core\SharedBundle\Repository\ProductRepository")
 */
class Product
{
    /**
    ...
    /**
     * @ORM\Column(name="integration_engine_category_id", type="integer")
     */
     ...
     * @var string
     *
     * @ORM\Column(name="in_database", type="boolean")
     */
